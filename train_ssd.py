...
from vision.datasets.darknet_dataset import DarknetDataset
...
if __name__ == '__main__':
    ...
    for dataset_path in args.datasets:
        ...
        elif args.dataset_type == 'darknet':
            dataset = DarknetDataset(dataset_path, is_test=False,
                 transform=train_transform, target_transform=target_transform)
            label_file = os.path.join(args.checkpoint_folder, "labels.txt")
            store_labels(label_file, dataset.class_names)
            logging.info(dataset)
    ...
    if args.dataset_type == "voc":
        ...
        val_dataset = DarknetDataset(args.datasets[0], is_test=True, 
                                        transform=test_transform, target_transform=target_transform)
